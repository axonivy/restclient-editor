  ...
  return (
    ...
    >
      <ResizableGroup orientation='horizontal' defaultLayout={defaultLayout} onLayoutChanged={onLayoutChanged}>
        <ResizablePanel id='restclient-editor-main' defaultSize='50%' minSize='30%' className='bg-n75'>
        ...
        {detail && (
          <>
            <ResizableHandle />
            <ResizablePanel id='restclient-editor-detail' defaultSize='25%' minSize='20%'>
              <Flex direction='column' className='h-full'>
