...
export const RestClientToolbar = () => {
  ...
  useHotkeys(
    ...
    () => {
      setDetail(true);
      document.querySelector<HTMLElement>('.restclient-editor-detail-header')?.focus();
    },
    {
      scopes: ['global']
    }
  ...
  return (
    <Toolbar tabIndex={-1} ref={firstElement} className='restclient-editor-main-toolbar'>
      <ToolbarTitle className='restclient-editor-main-toolbar-title'>{t('title.main', { name: context.pmv })}</ToolbarTitle>
      <Flex gap={1}>
