...
[![translation-status](https://hosted.weblate.org/widget/axonivy/restclient-editor/svg-badge.svg)](https://hosted.weblate.org/engage/axonivy/)
...
- Launch `Standalone` config to work with an ivyEngine backend.
  ...
  2. Open the test project in an ivy VsCode workspace or run the playwright global setup script.
